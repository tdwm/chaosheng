<div class="row-fluid">
    ...
    <?php echo $form->dropDownListRow($model,'user_id',CHtml::listdata(Users::model()->findAllByAttributes(array('user_role'=>'4')), 'id', 'displayName'),array('class'=>'span5')); ?>
    <?php echo $form->textFieldRow($model,'api_url',array('class'=>'span5','style'=>'width:96%')); ?>
