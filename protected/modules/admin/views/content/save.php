	    ...
	    <div class="span8">
	        <?php $this->beginWidget('bootstrap.widgets.TbBox', array(
    			...
    			<div class="control" style="margin-bottom: 20px;">
	    	    	<?php echo $form->textField($model, 'title', array('placeholder' => '标题', 'style' => 'width: 98%')); ?>
	    	    </div>
    	        ...
    	        <?php echo $form->textArea($model, 'extract', array('style' => 'width: 98%; height: 100px', 'placeholder' => '填写摘要')); ?>
	    	    </div>
	        <?php $this->endWidget(); ?>
	    </div>
	    <div class="span4">
