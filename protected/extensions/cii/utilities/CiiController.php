...
class CiiController extends CController
{
    ...
    public function getCategories()
    {
        ...
        if ($categories == false)
        {
            ...
            $categories = Yii::app()->db->createCommand('SELECT categories.id AS id, categories.name AS name, categories.parent_id, categories.slug  AS slug FROM categories  ')->queryAll();
