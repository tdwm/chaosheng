...
class UEditor extends CInputWidget
{
    ...
    private $defaultToolbars = array(
        array(
            'fullscreen', 'source','selectall', 'cleardoc', 'removeformat', 'formatmatch','autotypeset', '|',
            '', 'indent', '|','undo', 'redo', '|',
    ...
    private $defaultiframeCss = 'themes/iframe.css';
    public $CssFile = 'themes/default/css/ueditor.css';
